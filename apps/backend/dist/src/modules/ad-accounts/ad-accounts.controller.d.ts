...
export declare class AdAccountsController {
    private readonly adAccountsService;
    constructor(adAccountsService: AdAccountsService);
    ...
    sync(tenantId: string, id: string): Promise<{
        synced: number;
        accountId: string;
        message: string;
    }>;
