...
export declare class FunnelsController {
    ...
    createFromTemplate(tenantId: string, user: CurrentUserPayload, body: {
        templateId: string;
        name?: string;
        slug?: string;
    }): Promise<{
    ...
    create(tenantId: string, user: CurrentUserPayload, dto: CreateFunnelDto): Promise<{
        name: string;
        id: string;
        slug: string;
        createdAt: Date;
    ...
    update(tenantId: string, id: string, dto: UpdateFunnelDto): Promise<{
        name: string;
        id: string;
        slug: string;
        createdAt: Date;
