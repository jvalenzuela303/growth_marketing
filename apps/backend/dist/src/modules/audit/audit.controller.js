...
let AuditController = class AuditController {
    ...
    async getLogs(tenantId, role, resource, userId, action, from, to, page, limit) {
        if (role !== 'owner' && role !== 'admin') {
            throw new common_1.ForbiddenException('Solo administradores pueden ver los logs de auditoría.');
        }
...
__decorate([
    ...
    __param(1, (0, user_role_decorator_1.UserRole)()),
